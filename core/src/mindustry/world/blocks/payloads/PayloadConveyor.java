...
public class PayloadConveyor extends Block{
    ...
    public class PayloadConveyorBuild extends Building{
        ...
        public void onProximityUpdate(){
            ...
            if(accept != null && (
                //same size
                (accept.block.size == size && Point2.equals(Hex.nearby(tileX(), tileY(), rotation, size).x, Hex.nearby(tileX(), tileY(), rotation, size).y, accept.tileX(), accept.tileY())) ||
            ...
            int ntrns = 1 + size/2;
            Point2 p2 = Hex.nearby(tile.x, tile.y, rotation, ntrns);
            Tile next = world.tile(p2.x, p2.y);
